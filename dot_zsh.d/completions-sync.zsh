...
zstyle ':fzf-tab:*' fzf-flags --color=fg:#f8f8f2,bg:#282a36,hl:#bd93f9,fg+:#f8f8f2,bg+:#44475a,hl+:#bd93f9,info:#ffb86c,prompt:#50fa7b,pointer:#ff79c6,marker:#ff79c6,spinner:#ffb86c,header:#6272a4 --preview-window='bottom,40%,border-rounded'
# Use only prefix-based query: carapace uses _describe (not _files) for file
# completions, so hpre/apre are unset — the 'input' fallback passes the raw
# directory path as the fzf query, matching nothing (0/N).
