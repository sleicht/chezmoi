...
description: |
  This skill should be used when the user asks to "write requirements", "create a PRD",
  "gather requirements", "document feature specs", "write user stories", "define NFRs",
...
2. Plan tasks for each requirement type
