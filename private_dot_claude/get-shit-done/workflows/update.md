...
(Paths are relative to your install location: `/Users/stephanlv_fanaka/.claude/` for global, `./.claude/` for local)
...
**If GLOBAL install:**
```bash
rm -f /Users/stephanlv_fanaka/.claude/cache/gsd-update-check.json
```
