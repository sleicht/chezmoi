...
```bash
PHASE_INFO=$(node /Users/stephanlv_fanaka/.claude/get-shit-done/bin/gsd-tools.cjs find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node /Users/stephanlv_fanaka/.claude/get-shit-done/bin/gsd-tools.cjs roadmap get-phase "${PHASE}")
...
```bash
PHASE_DIR=$(node /Users/stephanlv_fanaka/.claude/get-shit-done/bin/gsd-tools.cjs find-phase "${PHASE}" --raw)
```
